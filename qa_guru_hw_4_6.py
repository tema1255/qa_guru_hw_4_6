...
def test_dark_theme_by_time_and_user_choice():
    ...
    if time(22) <= current_time or current_time < time(6) or dark_theme_enabled_by_user == True:
        is_dark_theme = True
    else:
        is_dark_theme = False
...
# "Open Browser [Chrome]"
def rename_func(func_name, *args):
    renamed_func = f'{func_name.__name__.replace("_", " ").title()} [{", ".join(args)}]'
    print(renamed_func)
    return renamed_func
